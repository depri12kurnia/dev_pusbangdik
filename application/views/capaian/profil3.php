                    ...
                    <ul class="latest-posts-list">
                        ...
                        <?php foreach ($listing as $listing) { ?>
                            <li class="clearfix" style="list-style:none;">
                                <figure><img src="<?php if ($listing->gambar == "") {
                                                        echo base_url('assets/upload/image/thumbs/' . $site->icon);
                                                    } else {
                                                        echo base_url('assets/upload/image/thumbs/' . $listing->gambar);
                                                    } ?>" alt="<?php echo $listing->judul_berita ?>" class="img img-rounded img-thumbnail">
                                </figure>
                                <div class="entry-content">
                                    <h5><a href="<?php echo base_url('berita/profil/' . $listing->slug_berita) ?>"><?php echo $listing->judul_berita ?></a>
                                    </h5>
