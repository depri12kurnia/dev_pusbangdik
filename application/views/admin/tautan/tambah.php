...
// Form open
echo form_open_multipart(base_url('admin/tautan/tambah'));
?>
    ...
    <div class="col-md-4">
        <div class="form-group form-group-lg">
            ...
            <input type="text" name="judul_tautan" class="form-control" placeholder="Judul Tautan" required="required"
                value="<?php echo set_value('judul_tautan') ?>">
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group form-group-lg">
            ...
            <input type="url" name="link_tautan" class="form-control" placeholder="Example : https://example.com"
                value="<?php echo set_value('link_tautan') ?>">
        </div>
    </div>
    <div class="col-md-4">
    ...
    <div class="col-md-8">
        <div class="form-group">
            ...
            <textarea name="isi" class="form-control" id="isi"
                placeholder="Isi tautan"><?php echo set_value('isi') ?></textarea>
        </div>
