...
<div class="row">
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <select name="bahasa" class="form-control">
                <option value="English" <?php if ($video->bahasa == "English") {
                                            echo "selected";
                                        } ?>>English</option>
                <option value="Indonesia" <?php if ($video->bahasa == "Indonesia") {
                                                echo "selected";
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <select name="posisi" class="form-control">
                ...
                <option value="Video" <?php if ($video->posisi == "Video") {
                                            echo "selected";
                                        } ?>>Video - Video page</option>
                <option value="Pui-pk" <?php if ($video->posisi == "Pui-pk") {
                                            echo "selected";
                                        } ?>>Video - PUI-PK page</option>
            </select>
        </div>
    ...
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <a href="<?php echo base_url('assets/images/video_youtube.png') ?>" target="_blank">
                <img src="<?php echo base_url('assets/images/video_youtube.png') ?>" class="img-responsive img-thumbnail">
            </a>
        </div>
