...
<div class="row">
    ...
    <div class="col-md-7">
        ...
        <div class="form-group">
            ...
            <textarea name="keahlian" id="keahlian" class="form-control"
                placeholder="Keahlian yang dikuasai"><?php echo set_value('keahlian') ?></textarea>
        </div>

        <div class="form-group">
            <label>Kata Kunci pencarian di Google</label>
            <textarea name="keywords" id="keywords" class="form-control"
                placeholder="Keywords"><?php echo set_value('keywords') ?></textarea>
        </div>
