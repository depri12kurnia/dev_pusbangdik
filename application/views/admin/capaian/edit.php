...
// Form open
echo form_open_multipart(base_url('admin/capaian/edit/' . $capaian->id_capaian));
?>
...
<div class="row">
    <div class="col-md-4">
        <div class="form-group form-group-lg">
            ...
            <input type="text" name="judul_capaian" class="form-control" placeholder="Judul capaian" required="required" value="<?php echo $capaian->judul_capaian ?>">
        </div>
    </div>
    <div class=" col-md-4">
        <div class="form-group form-group-lg">
            ...
            <select name="status_capaian" class="form-control">
                ...
                <option value="Draft" <?php if ($capaian->status_capaian == "Draft") {
                                            echo "selected";
                                        } ?>>Simpan
                    sebagai
                    draft</option>
    ...
    <div class="col-md-8">
        <div class="form-group">
            ...
            <textarea name="isi" class="form-control" id="isi" placeholder="Isi capaian"><?php echo $capaian->isi ?></textarea>
        </div>
